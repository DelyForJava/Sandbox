...
namespace PathologicalGames
{
    ...
    public sealed class SpawnPool : MonoBehaviour, IList<Transform>
    {
		...
		public void DespawnAll(Transform par)
		{
			var spawned = new List<Transform>(this._spawned);
			for (int i = 0; i < spawned.Count; i++) {
				if (spawned [i] != null) {
					this.Despawn (spawned [i], par);
				}
			}
		}

//		public void ResetAllSpawned(bool active)
//		{      
//			var spawned = new List<Transform>(this._spawned);
//			for (int i = 0; i < spawned.Count; i++)
//				this.ResetSpawned(spawned[i], active);
//		}
//
//		public void ResetAllSpawned(bool active, Transform par)
//		{
//			var spawned = new List<Transform>(this._spawned);
//			for (int i = 0; i < spawned.Count; i++)
//				this.ResetSpawned(spawned[i], active, par);
//		}
//
//		public void ResetSpawned(Transform tr, bool active)
//		{
//			tr.gameObject.SetActive (active);
//		}
//
//		public void ResetSpawned(Transform tr, bool active, Transform par)
//		{
//			tr.gameObject.SetActive (active);
//			tr.transform.parent = par;
//		}
