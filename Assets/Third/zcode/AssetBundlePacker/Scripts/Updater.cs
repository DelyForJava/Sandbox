...
namespace zcode.AssetBundlePacker
{
    public class Updater : MonoBehaviour
    {
        ...
        IEnumerator StartDownloadMainConfig()
        {
            ...
            {
                file_download_ = new FileDownload(current_url_, Common.CACHE_PATH, Common.MAIN_CONFIG_NAME_ARRAY[i]);
                ...
                {
                    Error(emErrorCode.DownloadMainConfigFileFailed, Common.MAIN_CONFIG_NAME_ARRAY[i] + " download failed!");
                    yield break;
                }
                file_download_ = null;
