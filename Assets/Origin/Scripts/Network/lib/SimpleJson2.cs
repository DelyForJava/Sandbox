...
namespace SimpleJson2
{
 ...
 MorefunJsonSerializerStrategy
        ...
        private static MorefunJsonSerializerStrategy _morefunJsonSerializerStrategy;
        [EditorBrowsable(EditorBrowsableState.Advanced)]
        public static MorefunJsonSerializerStrategy MorefunJsonSerializerStrategy
        {
            get
            {
                return _morefunJsonSerializerStrategy ?? (_morefunJsonSerializerStrategy = new MorefunJsonSerializerStrategy());
            }
        }
 ...
 interface IJsonSerializerStrategy
    ...
    public class MorefunJsonSerializerStrategy : IJsonSerializerStrategy
    {
        ...
        protected virtual bool TrySerializeUnknownTypes(object input, out object output)
        {
            ...
            {
                obj.Add(MapClrMemberNameToJsonFieldName(info.Name), info.GetGetMethod().Invoke(input, null));
               // obj.Add(MapClrMemberNameToJsonFieldName(info.Name), info.GetValue(input,null));
            }
            output = obj;
            return true;
        }
