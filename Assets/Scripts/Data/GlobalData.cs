...
namespace Bean.Hall
{
    public class GlobalData
    {
        ...
        public static int ChannelId = 10111;
        public static int AppId = 0;
        public static string CurrentVersionId = "0";
        ...
        public static string[] StepTips =
{
    ...
    public static class Event
    {
        ...
        public static IEnumerator GetInfo()
        {
            ...
            ////添加header校验
            //header.Add("Authorization", LoginData.Instance.GetHeaderValue(data, "plat/lobbyInfo?channelId=10111", "GET"));
           ...
           // request.uploadHandler = (UploadHandler)new UploadHandlerRaw(getBytes);
            ...
            request.SetRequestHeader("Authorization", LoginData.Instance.GetHeaderValue(data, "plat/lobbyInfo", "GET"));
